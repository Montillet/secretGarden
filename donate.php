...
<html>
	<head>
		<title><?php print T_("Contribuer");?></title>
											...
											<div class="8u skel-cell-important">
												...
												<!-- Content -->
													<article class="box is-post">
														...
														<header>
															<h2><?php print T_("Comment aider Secret Garden ?");?></h2>
															<span class="byline"><?php print T_("Conseil, aide au développement ou aide financière.");?></span>
														</header>
														<h3><?php print T_("Vous avez des conseils ou remarques à propos de Secret Garden ?  ");?></h3>
														
														<p><?php print T_("Vous aimez bien Secret Garden et vous avez des suggestions pour son développement faites nous en part sur le forum.");?>
														<br />
														<a href="http://blog.votre-secret-garden.fr/fr/forums/suggestion">Forum Secret Garden</a>
														</p>
												
														<h3><?php print T_("Vous voulez contribuer à l'évolution de Secret Garden ");?></h3>
														
														<p><?php print T_("Vous voulez traduire Secret Garden dans votre langue ou vous voulez améliorer la traduction de certaines phrases ? ");?> </p>
														<p><?php print T_("alors voici les étapes à suivre : ");?></p>
														<p><?php print T_("1- il vous faudra télécharger/installer Poedit. ");?>
														<br />
														<a href="http://www.poedit.net/download.php">Poedit</a>
														</p>
														<p><?php print T_("2- télécharger le fichier de traduction. ");?>
														<br />
														<a href="/locale/defaut.pot"><?php print T_("fichier de traduction pour de nouvelles langues");?></a>
														<a href="/locale/defaut.po"><?php print T_("fichier de traduction pour modifier la traduction anglaise");?></a>
														</p>
														<p><?php print T_("3- le traduire ^^ .");?></p>
														<p><?php print T_("4- une fois la traduction effectuée envoyer le fichier de traduction par mail a l'adresse-ci dessous.");?>
														<br />
														<a href="mailto:contact@votre-secret-garden.fr">contact@votre-secret-garden.fr</a>
														</p>
														
														<h3><?php print T_("Vous voulez nous aider sur le développement web ou C/C++ (Arduino) ? ");?></h3>
														<p><?php print T_(" envoyez nous vos évolutions .");?>
														<br />
														<a href="mailto:contact@votre-secret-garden.fr">contact@votre-secret-garden.fr</a>
														</p>
														
														<h3><?php print T_(" Faire un don ? ");?></h3>
														<p><?php print T_(" Que ferons-nous de cet argent ? ");?></p>
														<p><?php print T_(" vos dons serviront à maintenir la qualité de fonctionement du serveur et des services disponibles sur Secret Garden.");?></p>
														
																	
														<form action="https://www.paypal.com/cgi-bin/webscr" method="post" target="_top">
														<input type="hidden" name="cmd" value="_s-xclick">
														<input type="hidden" name="hosted_button_id" value="YY23GLW44DCWG">
														<input type="image" src="https://www.paypalobjects.com/en_US/i/btn/btn_donate_LG.gif"  name="submit" alt="PayPal - The safer, easier way to pay online!">
														<img alt="" src="https://www.paypalobjects.com/fr_FR/i/scr/pixel.gif" width="1" height="1">
														</form>
														<p></p>
														<p><?php print T_("Faire un don avec Bitcoins utilisez cette adresse : ");?>1HakD2Q5EahwXXnip98EJWWf67fYcKBsxb</p>
														<a href="bitcoin:1HakD2Q5EahwXXnip98EJWWf67fYcKBsxb"><img alt="bitcoin_qr_code" src ="/images/bitcoin_qr.jpg"></a>
