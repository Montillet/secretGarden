...
<html>
	<head>
		<title><?php print T_("Erreur");?></title>
											...
											<div class="8u skel-cell-important">
												...
												<!-- Content -->
													<article class="box is-post">
														...
														<header>
															<h2><?php print T_("Erreur dans le paiement");?></h2>
														</header>
														<p><?php print T_("Secret Garden a détecter une erreur dans votre paiement");?></p>
														<p><?php print T_("Vous allez être redirigé vers la page d'accueil.");?> </p>
