...
<html>
	<head>
		<title><?php print T_("Merci");?></title>
											...
											<div class="8u skel-cell-important">
												...
												<!-- Content -->
													<article class="box is-post">
														...
														<header>
															<h2><?php print T_("Merci votre donation a bien était reçu. ");?></h2>
														</header>
														<p><?php print T_("Secret Garden vous remercie de cette donation vous faites maintenant partie du cercle des généreux donateurs et à ce titre vous serez informez de toutes les évolutions que vos donations auront permis.");?></p>
														<p><?php print T_("Sachez aussi que pour chaque donation, vous recevrez un petit cadeau !");?></p>													
													</article>
											</div>
										</div>
									</div>
